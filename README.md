...
Packages/MapCore/        pure Swift package: geometry, keyframe policy, voxel maps, codecs, storage, backend; 399 unit tests
App/                     iOS app: Capture (ARKit, keyframe processing), Rendering (Metal), Cloud (backend client), UI (SwiftUI), Support
